...
//articleNo로 게시글 객체를 얻어서 현재 로그인된 사용자가 소유자인지를 검사
User user = (User) session.getAttribute("user");
BoardService service = new BoardService();
Article article = service.getArticle(articleNo);

//글 소유자와 로그인 사용자와 다르면 에러페이지로 보낸다. 
...
<div id="bbs">
<h2>수정</h2>
<form id="modifyForm" action="modify_proc.jsp" method="post" enctype="multipart/form-data" onsubmit="return check()">
