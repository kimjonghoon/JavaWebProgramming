...
<head>
<title>오브젝티파이</title>
<meta name="Keywords" content="java,자바,google app engine,구글 앱 엔진,google cloud,구글 클라우드,spring mvc,스프링 MVC,guestbook,방명록," />
<meta name="Description" content="오브젝티파이" />
...
<p>
오브젝티파이(Objectify)는 데이터스토어를 위해 만든 자바 API이다.<br />
...
그러기 위해 먼저 Greeting.java에 자신의 고유 키를 반환하는 메소드를 다음과 같이 추가한다.
</p>
...
Key는 자기 자신으로 복원할 수 있는 String을 반환하는 메소드인 toWebSafeString()을 가진다.
...
<p>
2. del() 메소드에 적용한 애노테이션에서 #greeting.author_id는 greeting 인스턴스의 getAuthor_id() 메소드를 호출한다.
