...
<p>
출석 관리를 위한 소프트웨어를 개발한다고 가정하자.
학생 객체의 속성과 행위를 다음과 같이 추릴 수 있다.
</p>
...
<tr>
	<td class="table-in-article-td">필드의 데이터 타입</td>
...
<p>
위 Student 클래스를 단독으로 실행할 수 있도록 만들자.
Student.java 파일을 열고, 아래와 같이 메인 메소드를 추가한다.
</p>
...
<dd>
이 문장은 변수 tom을 이용해서 학생 객체의 이름을 셋팅한다.
레퍼런스 변수를 사용해서 객체에 접근하려면 변수명 다음에 .(도트)를 쓰고 객체의 필드나 메소드를 표기한다.
</dd>
<dt>tom.absent();</dt>
<dd>
