...
<meta name="Description" content="자바스크립트로 폼 유효성 검사하기" />
...
<p>
<a th:href="@{/examples/send1.html}">예제 실행</a><br />
...
<p>
<a th:href="@{/examples/send2.html}">예제 실행</a><br />
...
<p>
<a th:href="@{/examples/send1-1.html}">예제 실행</a><br />
...
<p>
<a th:href="@{/examples/send1-2.html}">예제 실행</a><br />
</p>
...
<p>
<a th:href="@{/examples/send2-1.html}">예제 실행</a><br />

위 예제 역시 자바스크립트 코드를 분리하면 더 좋은 코드가 된다.<br />

<a th:href="@{/examples/send2-2.html}">예제 실행</a><br />
</p>
