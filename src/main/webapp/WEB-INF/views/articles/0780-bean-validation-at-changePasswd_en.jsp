...
<head>
<title>Bean Validation - Change Password</title>
<meta name="Keywords" content="bean validation,change password,hibernate-validator,@Size,@Valid,BindingResult,modelAttribute," />
<meta name="Description" content="This article describes Change password bean validation" />
