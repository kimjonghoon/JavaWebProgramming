...
<meta name="Description" content="Board Program Implementation" />
...
%&gt;</strong>           
  &lt;tr&gt;
    ...
    &lt;td&gt;
      ...
      <strong>&lt;% if (attachFileNum &gt; 0) { %&gt;</strong>&lt;img src="images/attach.png" alt="Attach File" style="vertical-align: middle;" /&gt;<strong>&lt;% } %&gt;</strong>
...
<p>
Download <a href="http://www.servlets.com/cos/cos-26Dec2008.zip">http://www.servlets.com/cos/cos-26Dec2008.zip</a> and unzip it. Copy cos.jar to WEB-INF/lib of your web application. Create a folder named upload on the document base. If your system is Unix-like, you need to set permissions on the upload folder.
</p>
...
&lt;%
<strong>User user = (User) session.getAttribute(WebContants.USER_KEY);
if (user == null) {
  response.sendError(HttpServletResponse.SC_FORBIDDEN, WebContants.NOT_LOGIN);
  return;
}
