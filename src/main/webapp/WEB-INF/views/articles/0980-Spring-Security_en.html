...
<meta name="Keywords" content="java,google app engine,google cloud,spring mvc,spring security,google accounts," />
<meta name="Description" content="Spring Security with Google Accounts" />
...
&lt;properties&gt;
  &lt;!-- omit --&gt;
  <strong>&lt;spring.security.version&gt;6.5.1&lt;/spring.security.version&gt;</strong>
&lt;/properties&gt;
</pre>
...
<ol>
  <li>This configuration is inevitable because login and logout perform outside.</li>
  <li>The authentication entry point redirects the user to the login page.</li>
  <li>It specifies the page to which the system redirects unauthorized users. Our view resolver will interpret /403 as /WEB-INF/views/403.jsp, so we need to create 403.jsp in the /WEB-INF/views folder and add a handler method that handles /403 requests to the controller.</li>
  <li>The authentication filter extracts the information (ID and password) required for authentication from the POST request of the login form. It saves the extracted data in the Authentication object and passes the Authentication object to the Authentication Manager.</li>
  <li>The authentication manager delegates the authentication decision to one of the authentication providers.</li>
  <li>Authentication providers verify who the user is. They compare the password retrieved from the repository with the password stored in the authentication object. If the passwords are the same, create a Principal and add it to the authentication object and return the authentication object.</li>
</ol>
...
&lt;beans xmlns="http://www.springframework.org/schema/beans"
  ...
  <strong>&lt;security:global-method-security pre-post-annotations="enabled" /&gt;</strong><b><span>&lt;!--</span>1. This config must be in this file.<span>--&gt;</span></b>
...
<ol>
  <li>Most of the Spring security configuration is in the security.xml file. However, this configuration must be in a Spring configuration file ending in -servlet.xml.</li>
</ol>
...
&lt;web-app xmlns="https://jakarta.ee/xml/ns/jakartaee"
  ...
  &lt;context-param&gt;
    ...
    &lt;param-value&gt;<b><span>&lt;!--</span>1. Spring configuration files<span>--&gt;</span></b>
...
<ol>
	<li>Spring configuration files to load before the configuration file (guestbook-servlet.xml) related to the Spring MVC servlet is loaded.</li>
</ol>
...
<h3>Create Files for Testing</h3>
