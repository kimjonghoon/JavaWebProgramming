...
<head>
<title>배열</title>
<meta name="Keywords" content="javascript,자바스크립트,Array,배열,length,splice,slice,concat,reverse,Associative arrays,getElementsByTagName" />
<meta name="Description" content="자바스크립트 배열 객체" />
