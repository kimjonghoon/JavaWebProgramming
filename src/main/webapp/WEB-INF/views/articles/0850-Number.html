...
<head>
<title>Number</title>
<meta name="Keywords" content="javascript,자바스크립트,toExponential,toPrecision,toFixed,toLocalString,toString,MAX_VALUE,MIN_VALUE,NEGATIVE_INFINITY,POSITIVE_INFINITY,NaN,valueOf,isNaN" />
<meta name="Description" content="자바스크립트 Number 객체" />
