...
<head>
<title>자바빈즈</title>
<meta name="Keywords" content="java,javabeans,board program" />
<meta name="Description" content="게시판 프로그램 자바빈즈 설계" />
...
<p>
자바 초보자는 자바빈즈를 프로젝트를 위해 만들어야 하는 자바 클래스라 이해하면 충분하다.
</p>

<h2>회원</h2>

<p>
다음은 화원과 관련된 자바 빈즈 목록이다.
</p>

<ul>
	<li>회원 가입 실패시 발생시킬 사용자 정의 예외: SignUpFailException.java</li>
	<li>회원: User.java</li>
	<li>회원 모듈의 펴시스턴스 계층: UserDao.java</li>
	<li>회원 모듈의 서비스 계층: UserService.java</li>
</ul>

<h6 class="src">SignUpFailException.java</h6>
...
<p>
다음 commons-logging.properties와 log4j2.xml를 src 폴더에 생성한다.
</p>
...
<p>
다음은 게시판에서 사용할 자바빈즈 목록이다.
</p>

<ul>
	<li>게시판 종류: Board.java</li>
	<li>게시글: Article.java</li>
	<li>댓글: Comment.java</li>
	<li>첨부 파일: AttachFile.java</li>
	<li>게시판 퍼시스턴스 계층: BoardDao.java</li>
	<li>게시판 서비스 계층: BoardService.java</li>
	<li>페이징 처리를 위한 숫자: NumbersForPaing.java</li>
</ul>

<h6 class="src">Board.java</h6>
...
<h6 class="src">AttachFile.java</h6>
<pre class="prettyprint">package net.java_school.board;
