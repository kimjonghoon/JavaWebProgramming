...
<li><a href="${blogUrl}/2019/how-to-make-epub-with-eclipse">이클립스를 사용해 EPUB ebook 만들기</a> - 2019.10.27</li>
<li><a href="${blogUrl}/2019/restful-url">RESTful URL</a> - 2019.10.22</li>
<li><a href="${blogUrl}/2019/how-to-make-epub">EPUB ebook 만들기</a> - 2019.10.9</li>
<li><a href="${blogUrl}/2019/java-development-environment-on-ubuntu-18">우분투 18.04에 자바 개발 환경 만들기</a> - 2019.10.5</li>
<li><a href="${blogUrl}/2019/java-9-modules">자바 9 모듈</a> - 2019.9.19</li>
<li><a href="${blogUrl}/2019/how-to-install-mariadb-on-ubuntu">우분투에 MariaDB 설치</a> - 2019.7.27</li>
<li><a href="${blogUrl}/2019/how-to-install-the-apache-on-ubuntu">우분투에 아파치 설치</a> - 2019.5.30</li>
<li><a href="${blogUrl}/2019/spring-thymeleaf">스프링 MVC에서 Thymeleaf 레이아웃 사용</a> - 2019.3.31</li>
<li><a href="${blogUrl}/2019/stream">스트림</a> - 2019.2.1</li>
<li><a href="${blogUrl}/2019/default-method">디폴트 메소드</a> - 2019.2.1</li>
<li><a href="${blogUrl}/2019/functional-programming">자바 8의 함수형 프로그래밍 지원</a> - 2019.2.1</li>
<li><a href="${blogUrl}/2019/reflection">리플렉션</a> - 2019.2.1</li>
<li><a href="${blogUrl}/2019/generics">제네릭</a> - 2019.2.1</li>
<li><a href="${blogUrl}/2019/enum">enum</a> - 2019.2.1</li>
...
<li><a href="${blogUrl}/2017/model2mysqlboard-using-DBCP">DBCP를 사용하는 MySQL 모델 2 게시판</a> - 2017.9.15</li>
<li><a href="${blogUrl}/2017/ajax-comment">Ajax 댓글</a> - 2017.9.8</li>
<li><a href="${blogUrl}/2017/model2-board-using-DBCP">DBCP를 사용하는 오라클 모델 2 게시판</a> - 2017.9.3</li>
<li><a href="${blogUrl}/2017/model2-board">모델 2 게시판</a> - 2017.9.3</li>
<li><a href="${blogUrl}/2017/model1-board">모델 1 게시판</a> - 2017.9.2</li>
<li><a href="${blogUrl}/2017/board-using-oracle-hierarchical-query">오라클 계층형 쿼리를 사용하는 게시판</a> - 2017.9.1</li>
