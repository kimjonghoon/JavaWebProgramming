...
<head>
<title>Building Spring MVC with Maven</title>
<meta name="Keywords" content="java,maven,spring mvc,mvn archetype:generate -Dfilter=maven-archetype-webapp,mvn clean compile war:inplace,SimpleUrlHandlerMapping,InternalResourceViewResolver,RequestMappingHandlerMapping,@Repository,@Service," />
<meta name="Description" content="Building Spring MVC with Maven" />
