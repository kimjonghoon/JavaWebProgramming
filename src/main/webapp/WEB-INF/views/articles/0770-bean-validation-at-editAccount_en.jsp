...
<head>
<title>Bean Validation - Edit Account</title>
<meta name="Keywords" content="bean validation,edit account,hibernate-validator,@Size,@Valid,BindingResult,modelAttribute," />
<meta name="Description" content="This article describes Edit Account bean validation" />
