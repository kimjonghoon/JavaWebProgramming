...
<head>
<title>소켓</title>
<meta name="Keywords" content="소켓,Socket,서버 소켓,ServerSocket,accept(),에코 프로그램,Echo program,채팅 프로그램,Chat program" />
<meta name="Description" content="자바 소켓 프로그래밍을 다룹니다" />
