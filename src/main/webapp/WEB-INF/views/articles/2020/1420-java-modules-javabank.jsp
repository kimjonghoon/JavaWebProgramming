...
<article>
<div class="last-modified">Last Modified 2025.6.25</div>

<h1>JavaBank 예제 모듈화</h1>

<p>
이 글은 <a th:href="@{/jdbc/JavaBank}">자바 은행</a> 예제를 모듈화하는 과정을 다룬다.<br />
</p>
...
<p>
<a href="https://www.oracle.com/database/technologies/appdev/jdbc-downloads.html">https://www.oracle.com/database/technologies/appdev/jdbc-downloads.html</a>에서 ojdbc17.jar를,
<a href="http://www.slf4j.org/download.html">http://www.slf4j.org/download.html</a>의 Maven central 링크에서 slf4j-api-1.7.36.jar와 slf4j-simple-1.7.36.jar을 내려받아, 모두 lib/ 폴더에 복사한다.
</p>
...
<p>
자바 은행이 slf4j-api-1.7.36.jar를 의존함을 확인했다.<br />
...
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/jdbc/JavaBank}">JDBC 예제 - 자바 은행</a></li>
	<li><a href="#" th:href="@{/blog/2019/java-9-modules}">자바 9 모듈</a></li>
	<li><a href="#" th:href="@{/blog/2020/java-modules-javabank}">자바 은행 예제 모듈화</a></li>
</ul>
