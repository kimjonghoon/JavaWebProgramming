...
<meta name="Keywords" content="java,자바,google app engine,구글 앱 엔진,google cloud,구글 클라우드,spring mvc,스프링 MVC,spring security,스프링 시큐리티,google accounts,구글 어카운트," />
<meta name="Description" content="구글 계정과 스프링 시큐리티 연동" />
...
<body><nav th:replace="~{commons/mainmenu_ko :: mainmenu}"></nav>
