...
<meta name="Keywords" content="java,eclipse,dynamic web project,다이나믹 웹 프로젝트,tomcat,톰캣,ROOT.xml,web.xml,server.xml" />
<meta name="Description" content="다이나믹 웹 프로젝트 생성에 대해 설명합니다" />
...
톰캣 9을 C:\ 드라이브에 설치다면 CATALINA_HOME은 C:\apache-tomcat-9.0.87이다.
ROOT.xml 파일은 C:\apache-tomcat-9.0.87\conf\Catalina\localhost에 저장해야 한다.<br />
ROOT.xml에서 docBase 값이 C:/www/JSPProject가 아니라는 점에 주의한다.<br />
