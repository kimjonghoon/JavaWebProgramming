...
<head>
<title>select 엘리먼트 다루기</title>
<meta name="Keywords" content="select,length,new Option,getElementById,onchange," />
<meta name="Description" content="select 엘리먼트 다루기" />
