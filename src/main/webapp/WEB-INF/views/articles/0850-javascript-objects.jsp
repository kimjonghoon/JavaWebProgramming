...
<pre class="prettyprint script-result-display">
<strong>const name = new String("홍길동");//또는 const name = "홍길동";</strong>
const engName = "gildong hong"
alert("1) 성명: " + name);
...
//테스트 데이터
const email = "hong@gmail.org";
const signUpDate = "2015/1/16";
...
const s1 = words.splice(2,2,'c','d');//인덱스2부터 2개 제거하고 2개의 요소 추가 

alert(words);
alert(s1);

const s2 = words.slice(2,4);//2는 포함 4는 포함되지 않는 부분 배열 반환
alert(s2);
alert(words);
</pre>
