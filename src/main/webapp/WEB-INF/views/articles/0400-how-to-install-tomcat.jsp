...
<p>
<img alt="tomcat windows service installer" src="<c:url value="/resources/images/tomcat-binary-distributions-windows-service-installer.png"/>" style="width: 364px;" />
</p>
...
<img alt="search tomcat" src="<c:url value="/resources/images/search-tomcat.png"/>" style="width: 100%;"/>
</p>

<p>
시스템 트레이에 있는 Monitor Tomcat을 클릭한다.<br />
<img alt="tomcat on system tray menu" src="<c:url value="/resources/images/tomcat-on-system-tray-menu.png"/>" style="width: 100%;" />
</p>

<p>
톰캣 속성 창이 나타나는데, 실행 타입으로 Automatic을 선택한다.
Automatic은 시스템이 실행할 때 톰캣이 함께 실행되게 한다.<br />
<img alt="톰캣 속성 창에서 Automatic 선택" src="<c:url value="/resources/images/tomcat-properties-startup-type-automatic.png"/>" style="width: 100%;" />
</p>

<p>
http://localhost:8080을 방문한다.<br />
<img src="<c:url value="/resources/images/tomcat-default-root.png"/>" alt="Tomcat default ROOT App" style="width: 100%;" />
</p>
...
<img alt="톰캣 매니저 앱 로그인 화면" src="<c:url value="/resources/images/login-to-manager.png"/>" style="width: 323px;" />
</p>

<p>
위에서 지정한 이름과 비밀번호를 입력하면, 톰캣 웹 애플리케이션 화면이 나타난다.<br />
<img alt="톰캣 매니저 앱 화면" src="<c:url value="/resources/images/tomcat-manager-app.png"/>" style="width: 100%;" />
</p>
