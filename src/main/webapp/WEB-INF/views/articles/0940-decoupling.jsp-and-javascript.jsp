...
<head>
<title>HTML에서 자바스크립트 분리</title>
<meta name="Keywords" content="javascript,자바스크립트,DOM,onload,getActivatedObject,getElementById,getElementsByTagName,jQuery," />
<meta name="Description" content="HTML에서 자바스크립트 분리하기" />
