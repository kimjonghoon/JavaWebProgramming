...
<meta name="Description" content="이 글은 Jakarta EE 9 예제를 설명합니다." />
...
<article>
<div class="last-modified">Last Modified 2024.3.31</div>

<h1>Jakarta EE 9</h1>

<p>
테스트 환경: JDK 11 LTS, Jetty 11
</p>
...
<p>
Jakarta EE 9에선 패키지 이름으로 javax.* 대신 jakarta.* 를 사용한다.
</p>
...
<p>
스프링 5.3.x 버전대는 Java EE 7-8 스펙을 따른다.<br />
스프링 6 버전은 Jakarta EE 9+ 스펙을 따른다.<br />
Spring 6은 최소 JDK 17, Apache Tomcat 10 또는 Jetty 11이 필요하다. 
</p>

<h3>책 예제를 Jakarta EE 9로 수정</h3>

<p>
책 예제를 Spring 6을 사용하도록 수정했다.<br />
Spring 6은 최소 JDK 17, Apache Tomcat 10 또는 Jetty 11이 필요하다.<br />
Test: JDK 17, Jetty 11, Spring 6, Spring-Security 6, Servlet 3 File Upload, DBCP2, MyBatis 3.5.x, Hibernate Validator 8
</p>

<p>
최종 소스: <a href="https://github.com/kimjonghoon/JavaWebProgramming2">https://github.com/kimjonghoon/JavaWebProgramming2</a>
</p>

<p>
<strong>실행 방법</strong><br />
src/main/resources/log4j2.xml 파일에서 로그 경로를 자신의 자신의 시스템에 맞게 수정한다.<br />
src/main/java/net/java_school/commons/WebContants.java 에서 UPLOAD_PATH를 자신의 시스템에 맞게 수정한다.<br />
톰캣이 정지시킨 후 아래 명령으로 jetty를 실행한다.<br />
mvn jetty:run
</p>
