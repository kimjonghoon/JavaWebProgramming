...
<head>
<title>다음 글, 이전 글 기능 수정</title>
<meta name="Keywords" content="java,web programming,pagination,Next Article,Prev Article,다음 글, 이전 글" />
<meta name="Description" content="이 글은 게시판 상세보기 페이지에서 [다음 글] [이전 글] 기능을 개선하는 과정을 설명합니다." />
...
<article>
<div class="last-modified">Last Modified 2022.10.25</div>

<h1>다음 글, 이전 글 기능 수정</h1>
...
<p>
'이전 글'의 번호가 현재 페이지의 마지막 글의 번호보다 작다면, viewForm 폼에서 page 값을 1 증가시켜야 한다.<br />
아래 그림 참조
</p>
...
<p>
'다음 글'의 번호가 현재 페이지의 첫 번째 글의 번호보다 크다면, viewForm 폼에서 page 값을 1 감소시켜야 한다.<br />
아래 그림 참조
</p>
...
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/blog/2022/testing-book-source-on-windows-10}">윈도 10에서 책 예제 테스트</a></li>
</ul>
