...
<img src="<c:url value="/resources/images/critical-section-problem.png"/>" alt="이 그림은 첫 번째 스레드가 잔고를 수정하기 전에 두번째 스레드가 출금액과 잔고를 비교하는 로직을 통과하여 문제를 발생한다는 예를 보여주고 있다." /><br />
...
<img src="<c:url value="/resources/images/critical-section-sync-1.png"/>" alt="그림은 첫 번째 스레드가 임계영역에 들어왔고 두번째 스레드가 임계영역 바로 앞까지 진행된다." /><br />
<img src="<c:url value="/resources/images/critical-section-sync-2.png"/>" alt="그림은 첫 번째 스레드가 임계영역에서 거의 통과하고 있는데 두번째 스레드는 아직 임계영역에 진입하지 못함을 보여준다." /><br />
<img src="<c:url value="/resources/images/critical-section-sync-3.png"/>" alt="그림은 첫 번째 스레드가 임계영역을 막 통과하기 전이고 두번째 스레드는 아직 임계영역에 진입하지 못함을 보여준다." /><br />

첫 번째 스레드가 메소드 밖으로 나가면 대기하고 있던 스레드가 메소드에 진입하게 된다.<br />
<img src="<c:url value="/resources/images/critical-section-sync-4.png"/>" alt="그림은 첫 번째 스레드가 임계영역을 통과했고 이제야 두번째 스레드가 임계영역에 진입한다." /><br />
