...
<head>
<title>Bean Validation - Sign Up</title>
<meta name="Keywords" content="bean validation,sign up,hibernate-validator,@Size,@Email,@Valid,BindingResult,modelAttribute," />
<meta name="Description" content="This article describes Sign Up bean validation" />
