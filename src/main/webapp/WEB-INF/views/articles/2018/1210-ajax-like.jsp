...
<head>
<title>좋아요 메뉴를 에이잭스로 구현</title>
<meta name="Keywords" content="like,ajax,좋아요," />
<meta name="Description" content="좋아요 메뉴를 에이잭스로 구현하기" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/ajax-like</span>
</p>
