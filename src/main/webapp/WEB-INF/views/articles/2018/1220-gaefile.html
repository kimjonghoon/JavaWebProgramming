...
<head>
<title>구글 클라우드 Blobstore 예제</title>
<meta name="Keywords" content="java,자바,google app engine,구글 앱 엔진,google cloud,구글 클라우드,blobstore,mvn appengine:run, gcloud components install app-engine-java" />
<meta name="Description" content="구글 클라우드 Blobstore 예제" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/gaefile</span><br />
(<a th:href="@{/blog/2017/ajax-fileupload}">에이젝스 파일 업로드</a> 예제를 Blobstore를 이용하는 것으로 수정)
</p>
...
<a th:href="@{https://cloud.google.com/sdk/downloads}">https://cloud.google.com/sdk/downloads</a>를 방문한다.<br />
