...
<meta name="Description" content="This article describes board program javabeans" />
...
<ul>
	<li>SignUpFailException.java</li>
	<li>User.java</li>
	<li>UserDao.java</li>
...
<p>
Get log4j-api-2.x.x.x.jar and log4-core-2.x.x.x.jar from <a href="http://logging.apache.org/log4j/2.x/download.html">http://logging.apache.org/log4j/2.x/download.html</a>.
</p>
...
public class UserDao {
  ...
  public void insert(User user) {
    ...
    try {
      ...
      throw new <strong>SignUpFailException("Sign Up Failed!");</strong>
    } finally {
...
<ul>
	...
	<li>Article.java</li>
	<li>Comment.java</li>
	<li>AttachFile.java</li>
	<li>BoardDao.java</li>
	<li>BoardService.java</li>
	<li>NumbersForPaging.java</li>
</ul>
