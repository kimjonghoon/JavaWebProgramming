...
<head>
<title>배열</title>
<meta name="Keywords" content="배열,스트링 리터럴,String literals" />
<meta name="Description" content="자바 배열에 대해 설명합니다" />
...
<h3>자바 프로그램에서 문자열 사용하기</h3>

<p>
자바는 String 클래스로부터 객체를 생성해 문자열을 표현한다.
"안녕하세요"라는 문자열이 필요하면 다음과 같이 코딩한다.
</p>
...
<h3>main 메소드에 String[] 배열를 전달하는 방법</h3>
