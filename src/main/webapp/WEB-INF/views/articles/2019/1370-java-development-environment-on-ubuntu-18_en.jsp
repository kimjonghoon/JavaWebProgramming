...
<head>
<title>Java Development Environment on Ubutnu 18.04</title>
<meta name="Keywords" content="Ubuntu 18.04,Java Development Environment on Ubuntu 18.04,Oracle 11g XE,MariaDB,Java Install,Maven Install,Git Install,Tomcat Install,Apache Install,Tomcat Connector Install,Eclipse Install" />
<meta name="Description" content="This articles describes how to set up java development environment on ubuntu 18.04" />
...
<ul id="related-articles-ul">
	<li><a th:href="@{/blog/2017/Setting-development-environment-in-Ubuntu}">Development in Ubuntu</a></li>
	<li><a th:href="@{/blog/2019/java-development-environment-on-ubuntu-18}">Java Development Environment on Ubutnu 18.04</a></li>
</ul>
