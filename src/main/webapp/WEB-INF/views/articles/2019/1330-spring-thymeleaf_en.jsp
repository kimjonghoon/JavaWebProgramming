...
<head>
<title>Using Layout of Thymeleaf in Spring MVC</title>
<meta name="Keywords" content="Java,Thymeleaf,spring mvc,Thymeleaf layout,java config,@Configuration,@EnableWebMvc,@ComponentScan,@Bean,AbstractAnnotationConfigDispatcherServletInitializer," />
<meta name="Description" content="Using Thymeleaf in Spring MVC" />
