...
<head>
<title>자바 9 모듈</title>
<meta name="Keywords" content="자바 9 모듈,Java 9 modules,Java 9 modules 실습,module-info.java" />
<meta name="Description" content="자바 9 모듈 실습" />
...
<article>
<div class="last-modified">Last Modified 2025.6.26</div>
...
<p>
<a th:href="@{/jdbc/Connection-Pool}">커넥션 풀</a> 소스를 모듈화하는 실습을 준비했다.<br />
실습하기 전 아랫글을 읽어 보는 게 좋다.
</p>

<ul>
	<li><a th:href="@{https://www.oracle.com/corporate/features/understanding-java-9-modules.html}">Understanding Java 9 Modules</a></li>
	<li><a th:href="@{http://openjdk.java.net/projects/jigsaw/quick-start}">Project Jigsaw: Module System Quick-Start Guide</a></li>
</ul>
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">javac -d out src/net/java_school/db/dbpool/*.java
...
<pre class="prettyprint">
<strong>import net.java_school.db.dbpool.Oracle;</strong>
...
public class GetEmp {
  ...
  public static void main(String[] args) {
	...
	<strong>.filter(provider -&gt; isOracle(provider.type())) //1.</strong>
	<strong>.map(ServiceLoader.Provider::get).findAny().get(); //2.</strong>
...
<pre class="prettyprint">
<strong>package net.java_school.db.dbpool.api;</strong>
...
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/blog/2020/java-modules-javabank}">자바은행 예제 모듈화</a></li>
</ul>
