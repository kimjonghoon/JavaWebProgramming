...
<meta name="Keywords" content="Java 9 modules,Java 9 modules Example,module-info.java,requires,exports,uses,provides ~ with," />
<meta name="Description" content="Java 9 Modules Example" />
...
<article>
<div class="last-modified">Last Modified 6.26.2025</div>
...
jars/
├── <a href="#ojdbc17.jar">ojdbc17.jar</a>
└── <a href="#mysql-connector-j-9.3.0.jar">mysql-connector-j-9.3.0.jar</a>
</pre>
...
<p>
<a href="https://www.oracle.com/kr/database/technologies/appdev/jdbc-downloads.html" id="ojdbc17.jar">Oracle JDBC Driver Download</a><br />
<a href="https://dev.mysql.com/downloads/connector/j/" id="mysql-connector-j-9.3.0.jar">MySQL JDBC Driver Download</a><br />
...
<pre class="cmd"> Volume in drive H has no label.
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">xcopy src\*.properties out
</pre>
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">set classpath=jars/ojdbc17.jar;jars/mysql-connector-j-9.3.0.jar;out
...
<pre class="shell-prompt">CP=jars/ojdbc17.jar
CP+=:jars/mysql-connector-j-9.3.0.jar
...
INFO: Registered JDBC driver com.mysql.cj.jdbc.Driver
...
<p>
<strong>requires</strong> java.logging;<br />
The <strong>requires</strong> keyword specifies on which this module depends the external module.<br />
java.logging is a module name, not a package name.
</p>

<p>
requires <strong>transitive</strong> java.sql;<br />
The module that depends on net.java_school.db.dbpool will automatically depend on java.sql.
</p>

<p>
<strong>exports</strong> net.java_school.db.dbpool;<br />
The <strong>exports</strong> keyword specifies the package that this module exports.<br />
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">javac -d out --module-source-path src ^
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">java -p jars:out -m main.app/net.java_school.test.GetEmp
</pre>
...
<p>
<strong>uses</strong> net.java_school.db.dbpool.ConnectionManager;<br />
A <strong>uses</strong> keyword specifies a service used by this module.<br /> 
...
<p>
<strong>provides</strong> net.java_school.db.dbpool.ConnectionManager<sup>Service</sup><br />
<strong>with</strong> net.java_school.db.dbpool.oracle.OracleConnectionManager<sup>Implementation</sup>;<br />
</p>
...
<p>
<strong>provides</strong> net.java_school.db.dbpool.ConnectionManager<sup>Service</sup><br />
<strong>with</strong> net.java_school.db.dbpool.mysql.MySqlConnectionManager<sup>Implementation</sup>;<br />
</p>
...
import java.sql.ResultSet;
import java.sql.SQLException;
<strong>import java.util.ServiceLoader;</strong>
...
public class GetEmp {
  ...
  public static void main(String[] args) {
    <strong>Iterable&lt;ConnectionManager&gt; managers = ServiceLoader.load(ConnectionManager.class);</strong>
		
    <strong>for (ConnectionManager manager : managers) {</strong>
      Connection con = null;
      PreparedStatement stmt = null;
      ResultSet rs = null;
      ...
      try {
        ...
        try {
          ...
          <strong>manager.freeConnection(con);</strong>
      }
      System.out.println("Driver Number: " + <strong>manager.getDriverNumber()</strong>);
    <strong>}</strong>
  }
}
</pre>
...
<pre class="prettyprint"><strong>import net.java_school.db.dbpool.Oracle;</strong>
...
<p>
<span class="repository">https://github.com/kimjonghoon/java-module-test</span>
</p>

<span id="related-articles">Related Articles</span>
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/blog/2020/java-modules-javabank}">JavaBank Modularization</a></li>
</ul>
...
<ul id="references">
	<li><a href="https://www.oracle.com/corporate/features/understanding-java-9-modules.html">Understanding Java 9 Modules</a></li>
	<li><a href="http://openjdk.java.net/projects/jigsaw/quick-start">Project Jigsaw: Module System Quick-Start Guide</a></li>
	<li><a href="https://dev.mysql.com/downloads/connector/j/">MySQL JDBC Driver Download</a></li>
	<li><a href="https://www.oracle.com/database/technologies/appdev/jdbc-downloads.html">Oracle JDBC Driver Download</a></li>
