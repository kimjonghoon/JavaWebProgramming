...
<head>
<title>RESTful URL</title>
<meta name="Keywords" content="RESTful URL,SpringBbs board program," />
<meta name="Description" content="This article discusses RESTful URL" />
...
<article>
<div class="last-modified">Last Modified 5.3.2025</div>
...
<pre class="prettyprint no-border">
@GetMapping("{boardCd}")
public String list(..., @PathVariable(name="boardCd") String boardCd, ...)
</pre>
...
public String view (..., @PathVariable(name="boardCd") String boardCd, @PathVariable(name="articleNo") Integer articleNo, ...)
</pre>
...
public String writeForm(@PathVariable(name="boardCd") String boardCd, ...)
</pre>
...
public String write(..., @PathVariable(name="boardCd") String boardCd, ...)
</pre>
...
public String modifyForm(..., @PathVariable(name="boardCd") String boardCd, ...)
</pre>
...
public String modify(..., @PathVariable(name="boardCd") String boardCd, @PathVariable(name="articleNo") Integer articleNo, ...)
</pre>
...
public String deleteArticle(@PathVariable(name="boardCd") String boardCd, @PathVariable(name="articleNo") Integer articleNo, ...)
</pre>
...
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/blog/2019/restful-url}">1 RESTful URL</a></li>
	<li><a href="#" th:href="@{/blog/2019/how-to-make-epub-with-eclipse}">2 How to make EPUB ebook with Eclipse</a></li>
</ul>
