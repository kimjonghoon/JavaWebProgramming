...
<head>
<title>스트림</title>
<meta name="Keywords" content="Java,자바,Stream,스트림,java 8,toList,filter,limit,collect,sorted,reversed,map,parallelStream," />
<meta name="Description" content="스트림" />
...
public class MovieTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    <strong>List&lt;Movie&gt; threeHighRatingMovieNames =</strong>
	<strong>movies.stream()</strong>
	<strong>.filter(m -&gt; m.getUserRatings() &gt;= 8.0)</strong>
