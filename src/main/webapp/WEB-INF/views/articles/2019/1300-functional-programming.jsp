...
<head>
<title>자바 8의 함수형 프로그래밍 지원</title>
<meta name="Keywords" content="Java,자바,java 8,Functional Programming,함수형 프로그래밍,Predicate,negate(),and()," />
<meta name="Description" content="자바 8의 함수형 프로그래밍 지원" />
