...
<meta name="Description" content="이 글은 RESTful URL에 대해 설명합니다" />
...
<p>
@GetMapping("{boardCd}")에서 {boardCd}는 글자 그대로를 의미하지 않는다.<br />
...
<ul id="related-articles-ul">
	...
	<li><a href="#" th:href="@{/blog/2019/how-to-make-epub-with-eclipse}">2 이클립스를 사용해 EPUB ebook 만들기</a></li>
</ul>
