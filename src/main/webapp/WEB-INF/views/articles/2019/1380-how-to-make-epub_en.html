...
<head>
<title>How to make EPUB ebook</title>
<meta name="Keywords" content="EPUB ebook,EPUB Directory,ncx,opf,UUID,EPUB Check,mimetype,container.xml," />
<meta name="Description" content="This article describes how to make epub ebook" />
...
<pre class="cmd">C:\Users&gt; javac MakeUUID.java
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">zip -0Xq MyFirstBook.epub mimetype
...
<div class="cmd-header">&nbsp;</div>
<pre class="cmd">java -jar C:/epubcheck-4.1.1/epubcheck.jar C:/Users/john/MyFirstBook/MyFirstBook.epub
</pre>
...
<ul id="related-articles-ul">
	<li><a href="#" th:href="@{/blog/2019/how-to-make-epub}">1 How to make EPUB ebook</a></li>
