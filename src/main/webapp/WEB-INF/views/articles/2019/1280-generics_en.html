...
<head>
<title>Generic</title>
<meta name="Keywords" content="java,Generic,Generic Method,Bounded Type Parameters,Type Inference,Target Types,Wildcards,Upper Bounded Wildcards,Unbounded Wildcards,Lower Bounded Wildcards,Wildcards and Subtyping,Type Erasure,Bridge Methods,Non-Reifiable Types,heap pollution,Varargs Methods,Restrictions on Generics," />
...
<pre class="prettyprint">Box&lt;String&gt; strBox = new Box&lt;&gt;();
Box rawBox = strBox;
...
<pre class="prettyprint">Object[] stringLists = new List&lt;String&gt;[2]; //compiler error, but pretend it's allowed
