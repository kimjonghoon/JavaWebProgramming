...
<head>
<title>Development in Ubuntu</title>
<meta name="Keywords" content="java,ubuntu,oracle 11g xe,scott account,jdk,maven,eclipse,git,board program,mysql,tomcat,maven jetty plugin," />
<meta name="Description" content="Set up the project on Ubuntu" />
...
<ul id="references">
  <li><a href="#" th:href="@{/blog/2017/Setting-development-environment-in-Ubuntu}">Development in Ubuntu</a></li>
  <li><a href="#" th:href="@{/blog/2019/java-development-environment-on-ubuntu-18}">Java Development Environment on Ubutnu 18.04</a></li>
  <li><a href="#" th:href="@{https://rogerdudler.github.io/git-guide/index.html}">https://rogerdudler.github.io/git-guide/index.html</a></li>
</ul>
