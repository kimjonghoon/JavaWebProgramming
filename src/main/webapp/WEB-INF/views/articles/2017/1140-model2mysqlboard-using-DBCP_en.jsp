...
<head>
<title>MySQL Model 2 Board program using DBCP</title>
<meta name="Keywords" content="java,model 2,board program,DBCP,mysql" />
<meta name="Description" content="Model 2 board for MySQL using DBCP" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/model2mysqlboard-using-DBCP</span>
</p>

<p>
For more information about DBCP, See <a href="#" th:href="@{/jdbc/Connection-Pool#DBCP}">DBCP</a>.
</p>
...
<p>
For more information about family, parent, depth, indent column, See <a href="#" th:href="@{/jsp/Thread-BBS}">Bulletin Boards with replies</a>
</p>
...
<ul id="references">
  <li><a href="#" th:href="@{/jsp/Thread-BBS}">Bulletin Boards with replies</a></li>
  <li><a href="#" th:href="@{/java/Logging#logback}">Logback</a>
  <li><a href="#" th:href="@{/jdbc/Connection-Pool#DBCP}">DBCP</a>
  <li><a href="#" th:href="@{/jsp/Model2}">Model 2</a></li>
</ul>
