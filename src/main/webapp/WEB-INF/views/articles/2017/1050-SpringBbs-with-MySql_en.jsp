...
<head>
<title>Spring board program using MySql</title>
<meta name="Keywords" content="java,spring mvc,spring security,board program,mysql" />
<meta name="Description" content="Spring Board program using MySql" />
...
public String list(@PathVariable(name="boardCd") String boardCd, @RequestParam(name="page") Integer page, 
    @RequestParam(name="seaarchWord")String searchWord, Locale locale, Model model) {
  if (page == null) page = 1;
