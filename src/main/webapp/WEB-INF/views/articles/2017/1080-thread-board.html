...
<head>
<title>계층형 게시판</title>
<meta name="Keywords" content="java,자바,board program,게시판,thread board,계층형 게시판,답변형 게시판," />
<meta name="Description" content="계층형 게시판" />
...
(<a th:href="@{/jsp/Thread-BBS}">계층형 게시판</a> 참조) 
</p>
