...
<meta name="Keywords" content="java,board program,thread board" />
<meta name="Description" content="Thread board" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/threadboard</span>
</p>

<p>
For more information, See the <a th:href="@{/jsp/Thread-BBS}">Bulletin board with replies</a>. 
</p>
...
<ul id="references">
  <li><a href="#" th:href="@{/jsp/Thread-BBS}">Bulletin board with replies</a></li>
</ul>
