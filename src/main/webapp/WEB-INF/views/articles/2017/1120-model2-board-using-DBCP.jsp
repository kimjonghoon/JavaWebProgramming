...
<head>
<title>DBCP를 사용하는 오라클 모델 2 게시판</title>
<meta name="Keywords" content="java,자바,board program,게시판,DBCP,Oracle,오라클,Model 2,모델 2" />
<meta name="Description" content="DBCP를 사용하는 오라클 모델 2 게시판" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/model2board-using-DBCP</span>
</p>
...
<p>
예제에서 사용하는 테이블과 시퀀스는 <a href="#" th:href="@{/blog/2017/board-using-oracle-hierarchical-query}">오라클 계층형 쿼리(Oracle Hierarchical Query)를 사용하는 게시판</a>과 같다.
</p>
