...
<meta name="Keywords" content="java,model 1,board program," />
<meta name="Description" content="Model 1 board" />
...
<p>
Source: <a th:href="@{https://github.com/kimjonghoon/model1board}">https://github.com/kimjonghoon/model1board</a><br />
For more information, see the <a th:href="@{/jsp/BBS-Model1}">Model 1 bulletin board</a>.
</p>
...
<ul id="references">
  <li><a href="#" th:href="@{/jsp/BBS-Model1}">Model 1 bulletin board</a></li>
</ul>
