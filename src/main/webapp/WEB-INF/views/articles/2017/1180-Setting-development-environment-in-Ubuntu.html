...
<head>
<title>우분투 자바 개발환경</title>
<meta name="Keywords" content="java,자바,ubuntu,우분투,oracle 11g xe,오라클,scott account,jdk,maven,eclipse,git,board program,mysql,tomcat,maven jetty plugin," />
<meta name="Description" content="우분투 자바 개발환경" />
...
<ul id="references">
	<li><a href="#" th:href="@{/blog/2017/Setting-development-environment-in-Ubuntu}">우분투 개발환경</a></li>
	<li><a href="#" th:href="@{/blog/2019/java-development-environment-on-ubuntu-18}">우분투 18.04에 자바 개발 환경 만들기</a></li>
	<li><a href="#" th:href="@{https://rogerdudler.github.io/git-guide/index.ko.html}">https://rogerdudler.github.io/git-guide/index.ko.html</a></li>
</ul>
