...
<head>
<title>DBCP를 사용하는 MySQL 모델 2 게시판</title>
<meta name="Keywords" content="java,자바,model 2,모델 2,board program,게시판,DBCP,mysql" />
<meta name="Description" content="DBCP를 사용하는 Model 2 MySQL 게시판" />
...
DBCP에 대한 자세한 설명은 <a href="#" th:href="@{/jdbc/Connection-Pool#DBCP}">DBCP</a>를 참조한다.
</p>
...
<p>
family,parent,depth,indent 컬럼에 대한 자세한 설명은 <a href="#" th:href="@{/jsp/Thread-BBS}">계층형 게시판</a>을 참조한다.
</p>
