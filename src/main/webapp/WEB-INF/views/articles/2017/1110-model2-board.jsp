...
<meta name="Keywords" content="java,자바,board program,게시판,model 2,모델 2" />
<meta name="Description" content="모델 2 게시판" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/model2board</span>
</p>

<p>
모델 2에 대한 자세한 설명은 <a href="#" th:href="@{/jsp/Model2}">모델 2</a>를 참조한다. 
</p>
...
('<a href="#" th:href="@{/jsp/Model2}">모델 2</a>'에서 사용한 테이블과 시퀀스 이름과 다르다.)
</p>
