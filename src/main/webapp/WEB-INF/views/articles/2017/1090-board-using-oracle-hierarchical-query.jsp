...
<head>
<title>오라클 계층형 쿼리를 사용하는 게시판</title>
<meta name="Keywords" content="java,자바,board program,게시판,Oracle hierarchical query,오라클 계층형 쿼리," />
<meta name="Description" content="오라클 계층형 쿼리를 사용하는 게시판" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/hierarchicalboard</span>
</p>

<p>
(설명은 <a th:href="@{/jsp/Thread-BBS#board-using-oracle-hierarchical-query}">오라클 계층형 쿼리를 사용하는 게시판</a> 참조) 
</p>
...
<ul id="references">
	<li><a href="#" th:href="@{/jsp/Thread-BBS#board-using-oracle-hierarchical-query}">오라클 계층형 쿼리를 사용하는 게시판</a></li>
</ul>
