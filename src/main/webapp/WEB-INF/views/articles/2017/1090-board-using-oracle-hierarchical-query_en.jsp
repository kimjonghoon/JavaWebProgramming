...
<head>
<title>Board program using Oracle hierarchical query</title>
<meta name="Keywords" content="java,board program,Oracle hierarchical query," />
<meta name="Description" content="Board program using Oracle hierarchical query" />
...
<ul id="references">
  <li><a href="#" th:href="@{/jsp/Thread-BBS#board-using-oracle-hierarchical-query}">Bulletin board using oracle hierarchical query</a></li>
</ul>
