...
<head>
<title>Oracle Model 2 Board program using DBCP</title>
<meta name="Keywords" content="java,board program,DBCP,Oracle,Model 2" />
<meta name="Description" content="Oracle Model 2 Board program using DBCP" />
