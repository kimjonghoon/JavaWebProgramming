...
<head>
<title>기본 게시판</title>
<meta name="Keywords" content="java,자바,basic board,기본 게시판," />
<meta name="Description" content="게시판의 기본적인 기능 설명" />
...
<p>
(예제는 게시판 기본 기능을 다룬다. <a th:href="@{/jsp/BBS-Study}">게시판 프로그램 이해하기</a> 참조) 
</p>
...
<ul id="references">
	<li><a href="#" th:href="@{/jsp/BBS-Study}">게시판 프로그램 이해하기</a></li>
</ul>
