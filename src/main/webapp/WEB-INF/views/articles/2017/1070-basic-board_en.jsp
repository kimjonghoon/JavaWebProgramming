...
<meta name="Keywords" content="java,basic board," />
<meta name="Description" content="Basic bulletin board" />
...
<p>
<span class="repository">https://github.com/kimjonghoon/basic-board</span>
</p>

<p>
This example covers the basics of the bulletin board. for more information, See <a th:href="@{/jsp/BBS-Study}">Understanding Bulletin Board Program</a>. 
</p>
...
<ul id="references">
  <li><a href="#" th:href="@{/jsp/BBS-Study}">Understanding bulletin board program</a></li>
</ul>
