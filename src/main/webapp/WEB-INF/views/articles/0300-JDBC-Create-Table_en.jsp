...
<head>
<title>JDBC - Create Table</title>
<meta name="Keywords" content="java,JDBC,create table,create sequence" />
<meta name="Description" content="This article describes How to create table and sequence using JDBC" />
